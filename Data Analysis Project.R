...
dat <- read.csv("LifeExpectancy.csv")
...
# Question 2: Adjusting for expenditures on health, is life expectancy in year 2019 associated with countries’ income groups?
...
# Question 3: Adjusting for expenditures on health, does the association between life expectancy in year 2019 and countries’ income 
# groups depend (interaction) on the life expectancy in year 2001? Carefully interpret the interaction.
model <- regress("mean", LifeExpectancy2019 ~ IncomeGroup+HealthExpenditure2019+LifeExpectancy2001+IncomeGroup:LifeExpectancy2001, data=dat)
model
